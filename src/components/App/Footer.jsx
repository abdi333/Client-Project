export default function Footer() {
    return (
        <div className="">
            <footer className="bg-blue-400 pt-4" >
                    ...
                    <div className="flex flex-wrap text-left lg:text-left">
                        <div className="w-full lg:w-6/12 px-4">
                            ...
                            <div className="mt-6 lg:mb-0 mb-6">                                
                                <a href="https://facebook.com" target="_blank"><button className="bg-white text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <img src="https://cdn-icons-png.flaticon.com/512/5968/5968764.png" /></button></a>
                                <a href="https://twitter.com" target="_blank"><button className="bg-white text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <img src="https://cdn-icons-png.flaticon.com/512/733/733579.png" /></button></a>
                                <a href="https://instagram.com" target="_blank"><button className="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                    <img src="https://cdn-icons-png.flaticon.com/512/1409/1409946.png" /></button></a>
                                <a href="https://linkedin.com" target="_blank"><button className="bg-white text-blueGray-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                        ...
                        <div className="w-full lg:w-6/12 px-2">
                            ...
                            <div className="flex flex-wrap items-top mb-6">
                                <div className="w-full lg:w-4/12 px-4 ml-auto">
                                    <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Products</span>
                                ...
                                <div className="w-full lg:w-4/12 px-4">
                                    <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Legal</span>
                                    <ul className="list-unstyled text-white">                                        
                                        <li>
                    ...
                    <div className="flex flex-wrap items-center md:justify-between justify-center">
                        <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                            <div className="text-sm text-blueGray-500 font-semibold py-1">
                                Copyright © <span id="get-current-year">2022 </span><a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800">Good Sport Golf Club</a>.
                            </div>
                        </div>
                    </div>
                </div>
