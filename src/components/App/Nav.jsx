          ...
          <div className="container mx-auto flex flex-wrap items-center justify-between">
            ...
            <div className="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
              <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                <li>
                  <a href="#" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent  block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0">Home</a>
                </li>
                <li>
                  <a href="#" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent  block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0">Join</a>
                </li>
                <li>
                  <a href="#" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent  block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0">Shop</a>
                </li>
                <li>
                  <a href="#" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent  block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0">Media</a>
                </li>
                <li>
                  <a href="#" className="text-white hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent  block pl-3 pr-4 py-2 md:hover:text-blue-400 md:p-0">About Us</a>
                </li>
              </ul>
            </div>
          </div>
