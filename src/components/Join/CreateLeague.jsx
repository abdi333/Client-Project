...
export default function CreateLeague() {
    ...
    return (
        <div>
            <div className="bg-white my-12 rounded-xl py-10 px-28 w-1/2 mx-auto shadow-xl">
                ...
                <form className="">
                    <div className="relative">
                        <select className="font-bold appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" ref={optionEl}>
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" type="text" placeholder="Organization" ref={orgEl} />
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" type="text" placeholder="First Name" ref={firstEl} />
                        <div className="absolute left-0 inset-y-0 flex items-center">
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" type="text" placeholder="Last Name" ref={lastEl} />
                        <div className="absolute left-0 inset-y-0 flex items-center">
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" type="text" placeholder="Phone Number" ref={phoneEl} />
                        <div className="absolute left-0 inset-y-0 flex items-center">
