...
export default function SignUp() {    
    ...
    return (
        <div className="p-8 lg:w-1/2 mx-auto my-12">
            ...
            <div className="bg-white rounded-b-lg py-6 lg:px-28 shadow-xl">
                ...
                <form className="mt-6">
                    ...
                    <div className="relative mt-3">
                        <input className="appearance-none border pl-12 border-grey shadow-sm focus:shadow-md focus:placeholder-gray-600 transition rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline"
                            type={isRevealPwd ? "text" : "password"} placeholder="Confirm Password" ref={keyEl} onChange={(e) => setKey(e.target.value)} />
                        <div className=" ">
                            <img src="https://cdn-icons-png.flaticon.com/512/641/641694.png" className="absolute inset-y-0 left-0 w-5 ml-3 pt-3"/>
                            <img className="w-6 pt-3 mr-3 absolute inset-y-0 right-0"
                                title={isRevealPwd ? "Hide password" : "Show password"}
                                src={isRevealPwd ? showPwdImg : hidePwdImg}
                                onClick={() => setIsRevealPwd(prevState => !prevState)} />
                    ...
                    <div className="flex items-center justify-center mt-8">
                        <button className=" text-white py-2 px-4 rounded bg-lightgreen hover:bg-lightgreen shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5"
                            onClick={function () {
